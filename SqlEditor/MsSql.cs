...

{
    public class MsSqlWithDaDt
    {
        ...
        {
            errorMsg = MsSql.FillDataTable(da, dt, sqlString, CommandType.Text);
        }
    ...
    public static class MsSql
    {
        ...
        public static string FillDataTable(DataTable dt, string sqlString)
        {
            ...
            return FillDataTable(da, dt, sqlString, CommandType.Text);
        }
        public static string FillDataTable(DataTable dt, string sqlString, CommandType cmdType)
        {
            SqlDataAdapter da = GetDataAdaptor(dt);
            da = new SqlDataAdapter();  //I guess
            return FillDataTable(da, dt, sqlString, cmdType);
        }

        public static string FillDataTable(SqlDataAdapter da, DataTable dt, string sqlString,CommandType cmdType)
        {
